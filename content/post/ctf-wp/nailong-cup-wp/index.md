---
title: "奶龙杯比赛 WP 汇总"
description: "奶龙杯 PWN 方向四道题目的完整 WP：复仇奶龙已归来、ret2text、BabySandbox、ezpwn。"
date: 2026-08-16T21:00:14+08:00
slug: "nailong-cup-wp"
image: ""
math: false
categories:
...
![image-20260816171039429](image-20260816171039429.png)
...
![image-20260816170333086](image-20260816170333086.png)

对可执行文件进行分析：

- **Arch**：amd64-64-little (x86_64)
...
![image-20260816170946635](image-20260816170946635.png)
...
![image-20260816165520623](image-20260816165520623.png)

可以知道开了Canary，NX保护

通过IDA反汇编可以看出

![image-20260816165038504](image-20260816165038504.png)

这里存在栈溢出，写入buf的字节数超过它的容量

![image-20260816165611147](image-20260816165611147.png)
...
![image-20260816170053629](image-20260816170053629.png)
...
![image-20260816164329863](image-20260816164329863.png)
...
1. **RWX 权限**：mmap 的保护标记设置为 7（PROT_READ | PROT_WRITE | PROT_EXEC），即**可读、可写、可执行**。这允许 Shellcode 在运行阶段修改自身代码数据。
2. **静态字节过滤**：程序对输入的机器码逐字节扫描，**禁止出现连续的 \x0f\x05**（即 x86_64 汇编中的 syscall 机器码）。
...
![image-20260816164415957](image-20260816164415957.png)
...
![image-20260816171241514](image-20260816171241514.png)

- **Canary**：开启（栈保护已启用，__readfsqword(0x28u)）
- **NX**：开启（栈不可执行）
- **PIE**：未开启 / 固定代码段加载基址
...
![image-20260816171313777](image-20260816171313777.png)
...
![image-20260816171350035](image-20260816171350035.png)
...
![image-20260816171505847](image-20260816171505847.png)
...
![image-20260816171659542](image-20260816171659542.png)
